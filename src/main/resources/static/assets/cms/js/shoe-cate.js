    ...
    $('#save').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data, status, xhr) {
                ...
                if (data!=null){
                    let html = `
                    <tr role="row" class="odd" id="shoes${data.id}">
                        ...
                        <td class="table-column-pl-0">
                            <h5 class="text-hover-primary mb-0" href="javascript:;">${data.ten}</h5>
                        </td>
                        <td>${data.ngayTao}</td>
                        <td>${data.ngaySua}</td>
                        <td>
                            <a href="javascript:;">${data.create}</a>
                         </td>
                        <td>
                            <a href="javascript:;">${data.update}</a>
                         </td>
                        <td>
                             <span class="legend-indicator bg-success"></span>Hiển Thị
                        </td>
                        <td>
                            <a class="btn btn-sm btn-white" href="javascript:;" data-toggle="modal" data-target="#editUserModal" data-name="${data.ten}" data-id="${data.id}" onclick="edit(this)">
                                <i class="tio-edit"></i>
                            </a>
                            <a class="btn btn-sm btn-white" href="javascript:;" data-id="${data.id}" onclick="deleteCategory(this)">
                    ...
                    `;
                    if (id == '') {
                        $('#dataInTable').append(html);
                    } else {
                        $('#shoes' + data.id).replaceWith(html);
                    }
                }
                switch (st) {
